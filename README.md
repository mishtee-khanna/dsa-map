...
Instead of staring at a huge checklist, follow connected learning paths, explore stations, practice problems, and track your progress through a visual metro-style interface.
...
🟡 FOUNDATIONS ────────┐
                       │
🔵 LINEAR STRUCTURES ───┼──→ 🔄 INTERCHANGES
                       │             │
🟠 SEARCH & SORT ──────┘             │
                                     ▼
                          ┌───────────────────┐
...
| ⚡ **Vanilla JavaScript** | Rendering, search, filtering & interactions |
| 🔤 **Google Fonts** | Space Grotesk · Inter · JetBrains Mono |

### 💡 Why Vanilla JavaScript?

This is intentionally a **zero-dependency static application**. No framework or build system is required, keeping it lightweight, fast, easy to understand, and simple to deploy.
...
> Or simply open `index.html` directly — no installation required.
